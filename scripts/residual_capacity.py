...
def main():
    ...
    df_out.to_csv('../src/data/OperationalLife.csv', index=False)
    ...
    df_out.to_csv('../src/data/ResidualCapacity.csv', index=False)
...
def get_can_op_life():
    ...
    df_op_life = pd.read_csv(
        '../dataSources/OperationalLifeTechnology.csv')
    ...
    df_trade = pd.read_csv('../dataSources/Trade.csv')
...
def get_can_res_cap(op_life, techs, tech_list_trade, df_trade):
    ...
    #read in raw operational life values
    df_res_cap = pd.read_csv('../dataSources/ResidualCapacitiesByProvince.csv')
...
def get_usa_op_life():
    ...
    df = pd.read_excel('../dataSources/USA_Data.xlsx',
                       sheet_name='OperationalLife(r,t)')
...
def get_usa_res_cap():
    ...
    df = pd.read_excel('../dataSources/USA_Data.xlsx',
                       sheet_name='ResidualCapacity(r,t,y)')
