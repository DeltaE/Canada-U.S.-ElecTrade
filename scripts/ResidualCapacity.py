...
def main():
    ...
    #          So if operational life is updated, residual capacity will also be updated. 
    # INPUT: none
    # OUTPUT: none

    #write Operational Life to a csv
    opLifeData, opLife, techs, techListTrade, dfTrade = getCanOperationalLife()
    ...
    resCapData = getCanResidualCapacity(opLife, techs, techListTrade, dfTrade)
...
def getCanResidualCapacity(opLife, techs, techListTrade, dfTrade):
    # PURPOSE: Creates ResidualCapacity CSV file from Canadian data
    # INPUT:   opLife = Dictionary from tech and year values
    #          techs = List of technologies pertaining to Operational Life
    #          techListTrade = Trade names without duplicates
    #          dfTrade = Raw Trade datafile
    # OUTPUT:  resCapData = Canadian Residual Capacity Data
