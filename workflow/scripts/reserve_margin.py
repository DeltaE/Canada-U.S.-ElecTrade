...
def main():
    ...
    output_dir = Path(Path(__file__).resolve().parent,
        '../../results/data/ReserveMargin.csv')
    df_rm.to_csv(output_dir, index=False)
    ...
    output_dir = Path(Path(__file__).resolve().parent,
        '../../results/data/ReserveMarginTagFuel.csv')
    df_rm_fuel.to_csv(output_dir, index=False)
    ...
    output_dir = Path(Path(__file__).resolve().parent,
        '../../results/data/ReserveMarginTagTechnology.csv')
    df_rm_tech.to_csv(output_dir, index=False)
...
def get_usa_rm_tag_fuel():
    ...
    #Modeled peak Demand
    df_modeled_profile = pd.read_excel(Path(Path(__file__).resolve().parent,
        '../../resources/USA_Data.xlsx'),
